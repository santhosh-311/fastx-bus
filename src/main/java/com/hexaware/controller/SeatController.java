...
//	}
	...
	@DeleteMapping("/op/removeseats/{busId}")
	public ResponseEntity<String> removeSeats(@PathVariable Integer busId) throws BusNotFoundException, SeatNotFoundException{
		String s = seatService.removeMultipleSeats(busId);
