...
public class UserController {
    ...
    public ResponseEntity<UserDTO> updateUser(@PathVariable String userName, @RequestBody UserDTO userDTO) throws UserNotFoundException, PhoneAlreadyExistsException {
